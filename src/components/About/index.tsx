              ...
              <div className="text-lg mt-8">
                ...
                <TabsContent value="pessoal">
                  <div className="text-center xl:text-left">
                    <h3 className="text-2xl font-semibold mb-4 ">Excelência e Inovação em Análise de Dados</h3>
                    <p className="text-base text-gray-600 max-w-xl mx-auto xl:mx-0 ">Tenho experiência sólida em <strong>análise de dados, visualização de informações e desenvolvimento de dashboards interativos.</strong> Meu objetivo é entregar soluções baseadas em dados que melhorem a performance, otimizem processos e gerem valor real para empresas e projetos.</p>
                ...
                <TabsContent value="skills">
                  <div className="text-left">
                    <h3 className="text-2xl font-semibold mb-8 text-center xl:text-left">Minhas Habilidades</h3>
                  </div>
                  <div className="mb-16">
                    <h4 className="text-xl font-semibold mb-2 text-center xl:text-left">Hard Skills</h4>
                    <div className="border-b border-border mb-8 xl:mb-4"></div>
                    { /* skill list*/}
                    <div >
                      {getData2(skillData, 'Hard')?.data.map((item: SkillsName, index: number)=>{
                        const {name} = item;
                        return (
                  ...
                  <div>
                    {/* tools */}
                    <div >
                      {getData2(skillData, 'Soft')?.data.map((item: SkillsName, index: number)=>{
                        const {name} = item;
                        return (
                          <div  className="w-2/4 xl:text-left xl:mx-0 mx-auto text-center mb-1"
                            key={index}>
